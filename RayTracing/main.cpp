...
int main() {
    ...
    auto vertexShaderSource = readFile("vertex_shader.glsl");
    auto fragmentShaderSource = readFile("fragment_shader.glsl");

    auto vertexShaderModule = compileShader(vertexShaderSource, shaderc_glsl_vertex_shader);
    auto fragmentShaderModule = compileShader(fragmentShaderSource, shaderc_glsl_fragment_shader);
